...
def register(mcp: MCPServer) -> None:
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "IF2601.CFFEX),需配 market=future:默认源走 akshare 新浪"
            " futures_main_sina(仅主连),显式 source=tushare 走 fut_daily"
            "(主连 IF0.CFFEX → 主力连续 IF.CFX 连续直取、具体合约 IF2601.CFX,"
            "2000 积分档实测可调,#395);主连仅研究信号/基准,不可当作可成交"
